...
export const renderExpenseList = (container, onExpenseDeleted) => {
    ...
    if (expenses.length === 0) {
      ...
      <div class="glass-card fade-in" style="text-align: center; padding: 3rem;">
        <p style="color: var(--text-secondary); font-size: 1.1rem;">No expenses recorded yet.</p>
        <p style="color: var(--text-secondary); font-size: 0.9rem; margin-top: 0.5rem;">Add your first expense to get started!</p>
      </div>
    `;
        return;
    }
